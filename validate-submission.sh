...
#
# Run:
#   curl -fsSL https://raw.githubusercontent.com/AshiqAbdulkhader/Emergency-Response-Allocation-Env/main/validate-submission.sh | bash -s -- <ping_url> [repo_dir]
#
...
log "  Build context:    $DOCKER_CONTEXT"
...
if command -v openenv &>/dev/null; then
  ...
  fail "Neither openenv nor uv command was found"
  hint "Install openenv-core directly or install uv and run from the project root."
  stop_at "Step 3"
fi
